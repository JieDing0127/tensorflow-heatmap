...
flags = tf.app.flags
flags.DEFINE_string("input", "images/00.jpg", "Path to input image ['images/cat.jpg']")
...
flags.DEFINE_integer("eval_image_size", 299, "Resize images to this size before eval")
flags.DEFINE_string("dataset_dir", "./imagenet", "Location of the labels.txt")
flags.DEFINE_string("checkpoint_path", "./imagenet/log", "saved weights for model")
